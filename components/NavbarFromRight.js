                    ...
                    <div className="relative mt-6 flex-1 px-4">
                      ...
                      <div className="absolute inset-0 px-4">
                        <div className="h-full" aria-hidden="true">
                          <ActiveLink activeClassName="text-gray-800" href="/">
                            <span className="px-2 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">First</span>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
                          <ActiveLink activeClassName="text-gray-800" href="/second">
                            <span className="px-2 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Second</span>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
                          <Menu>
                            {({ open }) => (
                                ...
                                <Menu.Items className="space-y-1 px-3">
                                  <Menu.Item>
                                    <ActiveLink activeClassName="text-gray-800" href="/third">
                                      <span className="block px-2 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Third</span>
                                    </ActiveLink>
                                  </Menu.Item>
                                  <hr className="my-1 mx-2 dark:border-neutral-800"/>
                                  <Menu.Item>
                                    <ActiveLink activeClassName="text-gray-800" href="/fourth">
                                      <span className="block px-2 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Fourth</span>
                                    </ActiveLink>
                                  </Menu.Item>
                                </Menu.Items>
                              </>
                          ...
                          <ActiveLink activeClassName="text-gray-900" href="/nav-bar">
                            <span className="block px-2 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Navbar</span>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
