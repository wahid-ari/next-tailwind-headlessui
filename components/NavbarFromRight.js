        ...
        <div className='flex items-center justify-between h-16'>
          ...
          <div className='-mr-1 flex md:hidden'>
            <button
              ...
              className='inline-flex items-center justify-center p-1.5 rounded-md text-gray-600 dark:text-neutral-300 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white'
            >
                    ...
                    <div className='relative mt-6 flex-1 px-4'>
                      ...
                      <div className='absolute inset-0 px-4'>
                        <div className='h-full' aria-hidden='true'>
                          <ActiveLink activeClassName='text-gray-800' href='/'>
                            <span className='px-2 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800'>
                              First
                            </span>
                          </ActiveLink>
                                ...
                                <Menu.Items className='space-y-1 px-3'>
                                  <Menu.Item>
                                    <ActiveLink activeClassName='text-gray-800' href='/third'>
                                      <span className='block px-2 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800'>
                                        Third
                                      </span>
                                    </ActiveLink>
                                  </Menu.Item>
