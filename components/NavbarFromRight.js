      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            ...
            <button className="inline-flex text-dark-500 border-2 py-1.5 px-4 dark:text-neutral-200 focus:outline-none hover:bg-gray-300 dark:hover:bg-neutral-800 duration-300 rounded text-base font-medium">
              Register
            </button>
          </div>
          {/* End Nav Button  */}
          ...
          <div className="-mr-1 flex md:hidden">
            <button onClick={() => setOpenMobileMenu(true)} className="inline-flex items-center justify-center p-1.5 rounded-md text-gray-600 dark:text-neutral-300 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                    ...
                    <div className="relative mt-6 flex-1 px-4">
                      ...
                      <div className="absolute inset-0 px-4">
                        <div className="h-full" aria-hidden="true">
                          <ActiveLink activeClassName="text-gray-800" href="/">
                            <a className="px-2 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">First</a>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
                          <ActiveLink activeClassName="text-gray-800" href="/second">
                            <a className="px-2 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Second</a>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
                          <Menu>
                            {({ open }) => (
                                ...
                                <Menu.Items className="space-y-1 px-3">
                                  <Menu.Item>
                                    <ActiveLink activeClassName="text-gray-800" href="/third">
                                      <a className="block px-2 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Third</a>
                                    </ActiveLink>
                                  </Menu.Item>
                                  <hr className="my-1 mx-2 dark:border-neutral-800"/>
                                  <Menu.Item>
                                    <ActiveLink activeClassName="text-gray-800" href="/fourth">
                                      <a className="block px-2 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Fourth</a>
                                    </ActiveLink>
                                  </Menu.Item>
                                </Menu.Items>
                              </>
                          ...
                          <ActiveLink activeClassName="text-gray-900" href="/nav-bar">
                            <a className="block px-2 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Navbar</a>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
