                ...
                <div className='flex h-full flex-col overflow-y-hide bg-white dark:bg-neutral-900 py-6 shadow-xl'>
                  ...
                  <div className='relative mt-2 flex-1'>
                    ...
                    <div className='absolute inset-0 pl-4 pr-2'>
                      <div
                        className='h-full py-1 flex flex-col gap-y-1 pl-1 pr-4 overflow-auto scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-neutral-700 scrollbar-thumb-rounded'
                        aria-hidden='true'
                      >
