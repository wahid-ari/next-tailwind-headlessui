        ...
        <>
              ...
              <div className='hidden lg:block'>
                <div className='ml-10 flex items-center space-x-4'>
                  <ActiveLink activeClassName='bg-gray-100 dark:bg-neutral-800' href='/'>
                    <span className='px-3 py-1 rounded-md text-base font-medium text-gray-600 dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-800 transition-all'>
                      Home
                    </span>
                  </ActiveLink>
                        ...
                        >
                          <Popover.Panel className='absolute bg-white dark:bg-[#111] shadow space-y-1 top-12 px-2 py-2 rounded w-52 z-10'>
                            <ActiveLink activeClassName='bg-gray-100 dark:bg-neutral-800' href='/components/#toc'>
                              <span className='block px-3 py-1 rounded-md text-base font-medium text-gray-600 dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-800 transition-all'>
                                Components
                              </span>
                            </ActiveLink>
          ...
          <Disclosure.Panel className='lg:hidden'>
            <div className='px-2 pt-2 pb-3 space-y-1 sm:px-3'>
              <ActiveLink activeClassName='bg-gray-100 dark:bg-neutral-800' href='/'>
                <span className='border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-800 transition-all'>
                  Home
                </span>
              </ActiveLink>
              <Menu>
                {({ open }) => (
                  <>
                    ...
                    <Menu.Items className='space-y-1 px-3'>
                      <Menu.Item>
                        <ActiveLink activeClassName='bg-gray-100 dark:bg-neutral-800' href='/components/#toc'>
                          <span className='block px-3 py-2 rounded-md text-base font-medium text-gray-600 dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-800 transition-all'>
                            Components
                          </span>
                        </ActiveLink>
                      </Menu.Item>
