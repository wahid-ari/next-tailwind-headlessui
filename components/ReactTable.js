    ...
    <div className="overflow-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-300 dark:scrollbar-thumb-neutral-700">
      ...
      <div className="pt-3 pb-5 sm:p-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex items-center gap-2 justify-center sm:justify-start">
          ...
          <button onClick={() => previousPage()} disabled={!canPreviousPage} aria-label="Prev" className="p-1">
          ...
          <button onClick={() => nextPage()} disabled={!canNextPage} aria-label="Next" className="p-1">
          ...
          <button onClick={() => gotoPage(pageCount - 1)} disabled={!canNextPage} aria-label="Last" className="p-1">
        ...
        <div className="flex items-center gap-2 justify-center sm:justify-end">
          ...
          <input
            ...
            className="text-sm transition-all w-20 px-3 py-[0.4rem] rounded-md
