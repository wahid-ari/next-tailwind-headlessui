            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              <div className="flex items-center justify-between h-16">
                ...
                <div className="hidden md:block">
                  <div className="flex items-center space-x-4">
                    ...
                    <Popover className="relative">
                      {({ open }) => (
                        <>
                          <Popover.Button className="group flex space-x-2 items-center px-2 py-1 rounded-md text-base font-medium text-gray-500 hover:text-gray-800 dark:text-neutral-200 transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-neutral-800">
                            <span>More</span>
                            <ChevronDownIcon
                ...
                <div className="-mr-2 flex md:hidden">
                  <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-600 dark:text-neutral-200 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
            ...
            >
              <Disclosure.Panel className="sm:px-10 md:hidden">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                  <ActiveLink activeClassName="text-gray-800" href="/">
                    <a className="border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">First</a>
                  </ActiveLink>
                  <hr className="mx-3 dark:border-neutral-800" />
                  <ActiveLink activeClassName="text-gray-800" href="/second">
                    <a className="border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Second</a>
                  </ActiveLink>
                  <hr className="mx-3 dark:border-neutral-800" />
                  <Menu>
                    {({ open }) => (
                  ...
                  <hr className="mx-3 dark:border-neutral-800" />
                  <ActiveLink activeClassName="text-gray-800" href="/nav-bar">
                    <a className="border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Navbar</a>
                  </ActiveLink>
                  <hr className="mx-3 dark:border-neutral-800" />
