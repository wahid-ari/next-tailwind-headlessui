            ...
            >
              <Disclosure.Panel className="sm:px-10 md:hidden">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                  <ActiveLink activeClassName="text-gray-800" href="/">
                    <span className="border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">First</span>
                  </ActiveLink>
                  <hr className="mx-3 dark:border-neutral-800" />
                  <ActiveLink activeClassName="text-gray-800" href="/second">
                    <span className="border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Second</span>
                  </ActiveLink>
                  <hr className="mx-3 dark:border-neutral-800" />
                  <Menu>
                    {({ open }) => (
                  ...
                  <hr className="mx-3 dark:border-neutral-800" />
                  <ActiveLink activeClassName="text-gray-800" href="/nav-bar">
                    <span className="border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Navbar</span>
                  </ActiveLink>
                  <hr className="mx-3 dark:border-neutral-800" />
