        ...
        <div className='flex h-16 items-center justify-between'>
          ...
          <div className='-mr-1 flex md:hidden'>
            <button
              ...
              className='inline-flex items-center justify-center rounded-md p-1.5 text-gray-600 hover:bg-gray-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 dark:text-neutral-200'
            >
              ...
              >
                <div className='pointer-events-auto relative w-screen max-w-md'>
                  ...
                  <div className='absolute right-0 top-0 mr-6 flex pt-6'>
                    <button
                      type='button'
                      className='rounded-md p-1 text-gray-500 ring-2 ring-gray-500 hover:text-gray-800 hover:ring-gray-800 dark:text-neutral-200'
                    ...
                    <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                      ...
                      <div className='absolute inset-0 px-4'>
                        <div className='h-full' aria-hidden='true'>
                          <ActiveLink activeClassName='text-gray-800' href='/'>
                            <span className='border-b-1 block rounded-md px-2 py-2 text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800'>
                              First
                            </span>
                          </ActiveLink>
                            ...
                            {({ open }) => (
                              <>
                                ...
                                <Menu.Items className='space-y-1 px-3'>
                                  ...
                                  <hr className='mx-3 my-1 dark:border-neutral-800' />
                                  <Menu.Item>
