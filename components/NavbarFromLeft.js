      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/">
              <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                ...
                <span className="ml-3 text-xl dark:text-neutral-100">Next</span>
              </a>
            </Link>
          </div>
          {/* web logo  */}
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-4">
              <ActiveLink activeClassName="text-gray-800" href="/">
                <a className="px-2 py-1 rounded-md text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">First</a>
              </ActiveLink>
              <ActiveLink activeClassName="text-gray-800" href="/second">
                <a className="px-2 py-1 rounded-md text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Second</a>
              </ActiveLink>
              <Popover className="relative">
                {({ open }) => (
                  <>
                    <Popover.Button className="group flex space-x-2 items-center px-2 py-1 rounded-md text-base font-medium text-gray-500 hover:text-gray-800 transition-colors duration-200 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">
                      <span>More</span>
                      <ChevronDownIcon
                    ...
                    >
                      <Popover.Panel className="absolute bg-white dark:bg-[#111] shadow space-y-1 top-12 px-2 py-2 rounded w-40">
                        <ActiveLink activeClassName="hover:text-gray-800" href="/third">
                          <a className="block px-3 py-1 rounded-md text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Third</a>
                        </ActiveLink>
                        <hr className="mx-2 dark:border-neutral-800" />
                        <ActiveLink activeClassName="hover:text-gray-800" href="/fourth">
                          <a className="block px-3 py-1 rounded-md text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Fourth</a>
                        </ActiveLink>
                      </Popover.Panel>
                    </Transition>
                  </>
              ...
              <ActiveLink activeClassName="text-gray-800" href="/nav-bar">
                <a className="px-2 py-1 rounded-md text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Navbar</a>
              </ActiveLink>
            </div>
          </div>
          {/* End Nav Link  */}
          ...
          <div className="hidden md:block">
            ...
            <button className="inline-flex text-dark-500 border-2 py-1.5 dark:text-neutral-200 dark:hover:bg-neutral-800 px-4 focus:outline-none hover:bg-gray-300 duration-300 rounded text-base font-medium">
              Register
            </button>
          </div>
          {/* End Nav Button  */}
          ...
          <div className="-mr-1 flex md:hidden">
            <button onClick={() => setOpenMobileMenu(true)} className="inline-flex items-center justify-center p-1.5 rounded-md text-gray-600 dark:text-neutral-200 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
              ...
              >
                <div className="pointer-events-auto relative w-screen max-w-md">
                  ...
                  <div className="absolute top-0 right-0 flex pt-6 mr-6">
                    <button
                      type="button"
                      className="rounded-md p-1 text-gray-500 dark:text-neutral-200 hover:text-gray-800 ring-2 ring-gray-500 hover:ring-gray-800"
                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">
                      ...
                      <div className="absolute inset-0 px-4">
                        <div className="h-full" aria-hidden="true">
                          <ActiveLink activeClassName="text-gray-800" href="/">
                            <a className="border-b-1 px-2 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">First</a>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
                          <ActiveLink activeClassName="text-gray-800" href="/second">
                            <a className="border-b-1 px-2 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Second</a>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
                          <Menu>
                            {({ open }) => (
                              <>
                                <Menu.Button className="border-b-1 px-2 w-full py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">
                                ...
                                <Menu.Items className="space-y-1 px-3">
                                  <Menu.Item>
                                    <ActiveLink activeClassName="text-gray-800" href="/third">
                                      <a className="block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Third</a>
                                    </ActiveLink>
                                  </Menu.Item>
                                  <hr className="my-1 mx-3 dark:border-neutral-800"/>
                                  <Menu.Item>
                                    <ActiveLink activeClassName="text-gray-800" href="/fourth">
                                      <a className="block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Fourth</a>
                                    </ActiveLink>
                                  </Menu.Item>
                                </Menu.Items>
                              </>
                          ...
                          <ActiveLink activeClassName="text-gray-900" href="/nav-bar">
                            <a className="border-b-1 px-2 block py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Navbar</a>
                          </ActiveLink>
                          <hr className="my-1 mx-2 dark:border-neutral-800"/>
