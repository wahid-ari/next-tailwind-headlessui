              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-center space-x-4">
                  <ActiveLink activeClassName="bg-blue-500 text-white" href="/">
                    <a className="px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">First</a>
                  </ActiveLink>
                  <ActiveLink activeClassName="bg-blue-500 text-white" href="/second">
                    <a className="px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Second</a>
                  </ActiveLink>
                        ...
                        >
                          <Popover.Panel className="absolute bg-white dark:bg-[#111] shadow space-y-1 top-12 px-2 py-2 rounded w-40">
                            <ActiveLink activeClassName="bg-blue-500 text-white" href="/third">
                              <a className="block px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Third</a>
                            </ActiveLink>
                            <ActiveLink activeClassName="bg-blue-500 text-white" href="/fourth">
                              <a className="block px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Fourth</a>
                            </ActiveLink>
                          </Popover.Panel>
                        </Transition>
                      </>
              ...
              <div className="rounded-lg px-2 shadow-md bg-white dark:bg-[#111] ring-1 ring-black ring-opacity-5 overflow-hidden">
                ...
                <div className="my-3">
                  ...
                  <ActiveLink activeClassName="bg-gray-800 text-white" href="/nav-bar">
                    <a className="border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800 hover:text-gray-800">Navbar</a>
                  </ActiveLink>
                </div>
              </div>
            </Popover.Panel>
