              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-center space-x-4">
                  <ActiveLink activeClassName="bg-blue-500 text-white" href="/">
                    <span className="px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">First</span>
                  </ActiveLink>
                  <ActiveLink activeClassName="bg-blue-500 text-white" href="/second">
                    <span className="px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Second</span>
                  </ActiveLink>
                        ...
                        >
                          <Popover.Panel className="absolute bg-white dark:bg-[#111] shadow space-y-1 top-12 px-2 py-2 rounded w-40 z-10">
                            <ActiveLink activeClassName="bg-blue-500 text-white" href="/third">
                              <span className="block px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Third</span>
                            </ActiveLink>
                            <ActiveLink activeClassName="bg-blue-500 text-white" href="/fourth">
                              <span className="block px-3 py-1 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800">Fourth</span>
                            </ActiveLink>
                          </Popover.Panel>
                        </Transition>
                      </>
              ...
              <div className="rounded-lg px-2 shadow-md bg-white dark:bg-[#111] ring-1 ring-black ring-opacity-5 overflow-hidden">
                ...
                <div className="my-3">
                  ...
                  <ActiveLink activeClassName="bg-gray-800 text-white" href="/nav-bar">
                    <span className="border-b-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800 hover:text-gray-800">Navbar</span>
                  </ActiveLink>
                </div>
              </div>
            </Popover.Panel>
