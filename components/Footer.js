...
export default function Footer() {
  return (
    <footer className='body-font text-gray-600 dark:border-t dark:border-t-neutral-800'>
      <div className='mx-auto flex max-w-7xl flex-col items-center px-4 pb-4 pt-10 sm:flex-row sm:px-6 md:px-8'>
        <Link
          href='/'
          passHref
          className='title-font flex items-center justify-center font-medium text-gray-900 md:justify-start'
        >
          <svg xmlns='http://www.w3.org/2000/svg' className='h-10 w-10' viewBox='0 0 1000 1000' fill='none'>
            <path
        ...
        <p className='mt-4 text-sm text-gray-500 dark:border-l-neutral-800 sm:ml-4 sm:mt-0 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:pl-4'>
          © 2020 Next
        </p>
