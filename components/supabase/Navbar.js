...
export default function Navbar({ sidebar }) {
  ...
  return (
    ...
    <nav className='-pl-2 sticky top-0 z-10 mx-auto flex h-12 max-w-screen-2xl border-b bg-white dark:border-b-neutral-800 dark:bg-neutral-900'>
      <div className='my-2 flex w-full items-center justify-between gap-x-2 px-3 md:px-4'>
