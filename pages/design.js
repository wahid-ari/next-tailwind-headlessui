      ...
      <Layout>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8">
          ...
          <div class="mx-auto px-8 py-10">
            <div class="py-10">
              <h1 class="text-3xl dark:text-white">Changelog</h1>
            ...
            <div>
              <div class="grid border-l dark:border-l-neutral-700 pb-10 lg:grid-cols-12 lg:gap-8">
                <div class="col-span-12 mb-8 self-start lg:sticky lg:top-0 lg:col-span-4 lg:-mt-32 lg:pt-32 ">
                  <div class="flex w-full items-baseline gap-6">
                    ...
                    <div class="flex w-full flex-col gap-1">
                      <h3 class="text-2xl dark:text-white">Platform update January 2023</h3>
                      <p class="text-lg dark:text-neutral-200">Feb 8, 2023</p>
                    </div>
                  </div>
                </div>
                <div class="col-span-8 ml-8 lg:ml-0">
                  <article class="prose max-w-none prose-h2:dark:text-neutral-200 prose-p:dark:text-neutral-200 prose-a:dark:text-neutral-200">
                    ...
                    <p><a href="https://supabase.com/blog/openai-embeddings-postgres-vector">Read the announcement</a></p>
                    ...
                    <ul>
                      <li><a href="https://supabase.com/blog/chatgpt-supabase-docs">Read the blog post</a></li>
                      <li><a href="https://www.youtube.com/watch?v=Yhtjd7yGGGA">Watch the video tutorial</a></li>
                    </ul>
                    ...
                    <ul>
                      <li><a href="https://supabase.com/docs/reference/csharp/">C# Client Library</a></li>
                      <li><a href="https://supabase.com/docs/reference/python/initializing">Python Client Library</a></li>
                    </ul>
                  </article>
                </div>
              </div>
              <div class="grid border-l dark:border-l-neutral-700 pb-10 lg:grid-cols-12 lg:gap-8">
                <div class="col-span-12 mb-8 self-start lg:sticky lg:top-0 lg:col-span-4 lg:-mt-32 lg:pt-32 ">
                  <div class="flex w-full items-baseline gap-6">
                    ...
                    <div class="flex w-full flex-col gap-1">
                      <h3 class="text-2xl dark:text-white">Platform Updates: November 2022</h3>
                      <p class="text-lg dark:text-neutral-200">Dec 8, 2022</p>
                    </div>
                  </div>
                </div>
                <div class="col-span-8 ml-8 lg:ml-0">
                  <article class="prose max-w-none prose-h2:dark:text-neutral-200 prose-p:dark:text-neutral-200 prose-a:dark:text-neutral-200">
                    ...
                    <p><a href="https://supabase.com/launch-week">Get your ticket</a></p>
                    ...
                    <p><a href="https://supabase.com/docs/guides/auth/auth-helpers/remix">Read the docs</a></p>
                    ...
                    <p><a href="https://supabase.com/docs/guides/storage/image-transformations#automatic-image-optimisation-webp">Read the docs</a></p>
                  </article>
                </div>
              </div>
            </div>
